...
from app.models import Usuario, Grupo, Categoria, Questao, Permissao
...
def make_shell_context():
    return dict(app=app, db=db, Usuario=Usuario, Grupo=Grupo, Categoria=Categoria, Questao=Questao, Permissao=Permissao)
